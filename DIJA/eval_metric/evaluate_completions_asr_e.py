...
def main():
    ...
    cls_tokenizer = AutoTokenizer.from_pretrained(args.cls_path, use_fast=False)
    ...
    for item in tqdm(completions, desc="Scoring completions", total=len(completions)):
        ...
        response = item["selected_responses"]
        ...
        try:
            ...
            print("put your api key in the code")
            return
        
        current_results = compute_results_classifier_without_vllm(
            behavior_dict, [item], client,
        )
